...
public class ItemsCRUDFrameSalePerson extends JFrame {

    private JTable itemsTable;
    private DefaultTableModel tableModel;

    public ItemsCRUDFrameSalePerson() {
        ...
        returnButton.addActionListener(e -> {
            dispose();
            new SalesPersonDashbaord(getTitle());  // Ensure AdminDashboard class exists
        });
    ...
    class ButtonEditor extends DefaultCellEditor {
        ...
        private void onButtonClick() {
            ...
            int choice = JOptionPane.showOptionDialog(ItemsCRUDFrameSalePerson.this,
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(ItemsCRUDFrameSalePerson::new);
    }
}
