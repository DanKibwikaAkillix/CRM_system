...
public class CustomerCRUDFrameSalePerson extends JFrame {
    private JTable customerTable;
    private DefaultTableModel tableModel;
    private JButton addCustomerButton;

    public CustomerCRUDFrameSalePerson() {
        ...
        backButton.addActionListener(e -> {
            dispose();
            new SalesPersonDashbaord(getTitle());
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(CustomerCRUDFrameSalePerson::new);
    }
}
